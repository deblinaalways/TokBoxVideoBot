...
protocol VideoRenderManagerDelegate {
    func renderer(_ renderer: VideoRenderManager, didReceiveFrame: OTVideoFrame)
}

class VideoRenderManager: UIView {
    ...
    override init(frame: CGRect) {
        ...
        NotificationCenter.default
            .addObserver(self, selector: #selector(VideoRenderManager.willResignActive),
                         name: NSNotification.Name.UIApplicationWillResignActive, object: nil)
        NotificationCenter.default
            .addObserver(self, selector: #selector(VideoRenderManager.didBecomeActive),
...
extension VideoRenderManager: GLKViewDelegate {
...
extension VideoRenderManager: OTVideoRender {
...
class DisplayLinkProxy {
    var renderer: VideoRenderManager
    var view: GLKView
    
    init(glkView: GLKView, videoRender: VideoRenderManager) {
